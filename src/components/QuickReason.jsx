      ...
      >
          ...
          >
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">Other (type in box)</span>
              </div>
            </button>
            ...
            {selectedReason === 'other' && (
              <motion.textarea
                ...
                className="w-full mt-3 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
        ...
        >
          <button
            ...
            className={`w-full py-4 px-6 rounded-lg font-bold transition-all duration-200 flex items-center justify-center space-x-2 ${
